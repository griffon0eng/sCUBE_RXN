...
void InitXintf16Gpio()
{
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO53 = 0;  // XD15
         ...
         //GpioCtrlRegs.GPAMUX1.bit.GPIO14 = 2;  // XHOLD
         //GpioCtrlRegs.GPAMUX1.bit.GPIO15 = 2;  // XHOLDA

         GpioCtrlRegs.GPBDIR.bit.GPIO53 = 1;

         GpioCtrlRegs.GPCDIR.bit.GPIO64 = 1;  // XD15
             GpioCtrlRegs.GPCDIR.bit.GPIO65 = 1;  // XD14
             GpioCtrlRegs.GPCDIR.bit.GPIO66 = 1;  // XD13
             GpioCtrlRegs.GPCDIR.bit.GPIO67 = 1;  // XD12
             GpioCtrlRegs.GPCDIR.bit.GPIO68 = 1;  // XD11
             GpioCtrlRegs.GPCDIR.bit.GPIO69 = 1;  // XD10
             GpioCtrlRegs.GPCDIR.bit.GPIO70 = 1;  // XD19
             GpioCtrlRegs.GPCDIR.bit.GPIO71 = 1;  // XD8
             GpioCtrlRegs.GPCDIR.bit.GPIO72 = 1;  // XD7
             GpioCtrlRegs.GPCDIR.bit.GPIO73 = 1;  // XD6
             GpioCtrlRegs.GPCDIR.bit.GPIO74 = 1;  // XD5
             GpioCtrlRegs.GPCDIR.bit.GPIO75 = 1;  // XD4
             GpioCtrlRegs.GPCDIR.bit.GPIO76 = 1;  // XD3
             GpioCtrlRegs.GPCDIR.bit.GPIO77 = 1;  // XD2
             GpioCtrlRegs.GPCDIR.bit.GPIO78 = 1;  // XD1
             GpioCtrlRegs.GPCDIR.bit.GPIO79 = 1;  // XD0

         GpioCtrlRegs.GPBDIR.bit.GPIO40 = 1;  // XA0/XWE1n
    	  GpioCtrlRegs.GPBDIR.bit.GPIO41 = 1;  // XA1
    	  GpioCtrlRegs.GPBDIR.bit.GPIO42 = 1;  // XA2
    	  GpioCtrlRegs.GPBDIR.bit.GPIO43 = 1;  // XA3
    	  ...
    	  GpioCtrlRegs.GPCDIR.bit.GPIO80 = 1;  // XA8
    	  GpioCtrlRegs.GPCDIR.bit.GPIO81 = 1;  // XA9
    	  GpioCtrlRegs.GPCDIR.bit.GPIO82 = 1;  // XA10
    	  GpioCtrlRegs.GPCDIR.bit.GPIO83 = 1;  // XA11
    	  GpioCtrlRegs.GPCDIR.bit.GPIO84 = 1;  // XA12
    	  GpioCtrlRegs.GPCDIR.bit.GPIO85 = 1;  // XA13
    	  GpioCtrlRegs.GPCDIR.bit.GPIO86 = 1;  // XA14
    	  GpioCtrlRegs.GPCDIR.bit.GPIO87 = 1;  // XA15



    	  GpioCtrlRegs.GPBDIR.bit.GPIO36 = 1;  // XZCS0
